...
class ValueRange():
    ...
    def __contains__(self,number):
        return number >= self.low and number <= self.high
...
class  MiscibilityTable():
    ...
    def formatResults(self,number,potion1,potion2):
        if number == 0:
            number = 100
...
tables = {
    "Based Variant":MiscibilityTable({
        ...
        ValueRange(92,99):"Miscible. **{pot1}** and **{pot2}** work normally unless their effects are contradictory, e.g. diminution / growth.",
        ValueRange(100,100):RandomFormat("Miscible. **{pot1}** becomes permenant and **{pot2}** is desytroyed.")
    })
}
