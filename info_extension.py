...
class Info(commands.Cog):
    ...
    async def _info(self, ctx: discord_slash.SlashContext):
        ...
        embed.add_field(name="Source Code", value="[View on GitHub]("
                                                  "https://github.com/ryleu/discord-cardic-inspiration)")
        # Add the invite link to the embed
        embed.add_field(name="Invite", value="[Add me to your own server]("
        ...
        embed.add_field(name="Syntax", value="[View the `/roll` syntax]("
